defmodule YookerWeb.LobbyLive do
  ...
  def handle_event("join_game", %{"join_game" => %{"game_id" => game_id, "player_name" => player}}, socket) do
    {:noreply, push_redirect(
      socket,
      to: YookerWeb.Router.Helpers.live_path(socket, YookerWeb.GameLive, game: game_id, player: player)
    )}
	end
